...
class FireDataset_npy(Dataset):
    def __init__(self, dataset_root: str | Path | None = None, access_mode: str = 'spatiotemporal',
                 problem_class: str = 'classification',
                 train_val_test: str = 'train', dynamic_features: list | None = None, static_features: list | None = None,
                 categorical_features: list | None = None, nan_fill: float = -1., neg_pos_ratio: int = 2, clc: str | None = None):
        """
